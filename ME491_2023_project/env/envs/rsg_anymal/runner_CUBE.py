...
if cfg_name == '' or cfg_name == 'none':
    print("No cfg file was given. Loading default from: "+task_path+"/cfg.yaml")
    cfg_path = task_path + "/cfg.yaml"
else:
    print("Loading config: "+cfg_name)
...
if starting_lr > 0: # reset the optimizer
    print("Using Prescribed Learning Rate: "+ str(starting_lr))
...
for update in range(1000000):
    ...
    print('--------------------------------------------------------')
    print('[ITERATION #{:>6}] RUNNER'.format(update))
